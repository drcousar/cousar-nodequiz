...
let AppComponent = class AppComponent {
    constructor(cookie, router, authGuard) {
        this.cookie = cookie;
        this.router = router;
...
let QuizSummaryDialogComponent = class QuizSummaryDialogComponent {
    constructor(dialogRef, data, questionData, cookieService) {
...
let QuizComponent = class QuizComponent {
    //END MOCK JSON Data
    constructor(route, cookieService, dialog, http) {
        this.route = route;
        this.cookieService = cookieService;
        this.dialog = dialog;
        this.http = http;
    ...
    onSubmit(formData) {
        ...
        */
        ...
        const summaryData = { 'quizId': this.quizResults['quiz'], 'employeeId': this.quizResults['employeeId'], 'date': moment__WEBPACK_IMPORTED_MODULE_7__().format(), 'score': this.quizResults['score'] };
        ...
        return this.http.post('/api/results', data, config).subscribe((res) => {
    ...
    writeCumScore(summaryData, config) {
        ...
        return this.http.post('/api/summary', summaryData, config).subscribe((res) => {
            console.log("POST: " + res);
        }, (err) => {
            console.log(err);
        }, () => {
    ...
    openDialog() {
        ...
        const dialogRef = this.dialog.open(_quiz_summary_dialog_quiz_summary_dialog_component__WEBPACK_IMPORTED_MODULE_6__["QuizSummaryDialogComponent"], {
            data: {
